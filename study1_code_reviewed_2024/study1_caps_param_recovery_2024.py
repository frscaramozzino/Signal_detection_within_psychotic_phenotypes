...
vat_caps_coh_sim2.sample(20000, burn=2000, thin=5,  dbname='hddm_c_caps_sim.db', db='pickle')
vat_caps_coh_sim2.save('hddm_c_caps_sim')

vat_caps_coh_sim2= hddm.load('hddm_c_caps_sim')
