...
for i in sample:
    ...
    pd.concat(simulated_data).to_csv('simulated_data_capsgroup_2024.csv')
    
mean_simulated_quantiles_caps=get_mean_sim_quantiles(simulated_data).assign(source = "simulated")

mean_simulated_quantiles_caps.to_csv('mean_simulated_quantiles_caps_2024.csv')
#%%
...
simulated_data_capsgroup=pd.read_csv('simulated_data_capsgroup_2024.csv')
