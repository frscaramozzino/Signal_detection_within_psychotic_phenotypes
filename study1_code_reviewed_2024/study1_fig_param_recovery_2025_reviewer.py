...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 13 15:43:35 2025
...
vat_caps_coh_sim= hddm.load('hddm_c_caps_sim_reviewer1')
...
#RMSE
mse_15_lcaps_v = str(mean_squared_error(par_est_15_lcaps['v'], par_sim_15_lcaps['v']).round(3))
mse_15_lcaps_v="".join([mse,mse_15_lcaps_v])
mse_15_hcaps_v = str(mean_squared_error(par_est_15_hcaps['v'], par_sim_15_hcaps['v']).round(3))
mse_15_hcaps_v="".join([mse,mse_15_hcaps_v])
mse_25_lcaps_v = str(mean_squared_error(par_est_25_lcaps['v'], par_sim_25_lcaps['v']).round(3))
mse_25_lcaps_v="".join([mse,mse_25_lcaps_v])
mse_25_hcaps_v = str(mean_squared_error(par_est_25_hcaps['v'], par_sim_25_hcaps['v']).round(3))
mse_25_hcaps_v="".join([mse,mse_25_hcaps_v])

mse_15_lcaps_a = str(mean_squared_error(par_est_15_lcaps['a'], par_sim_15_lcaps['a']).round(3))
mse_15_lcaps_a="".join([mse,mse_15_lcaps_a])
mse_15_hcaps_a = str(mean_squared_error(par_est_15_hcaps['a'], par_sim_15_hcaps['a']).round(3))
mse_15_hcaps_a="".join([mse,mse_15_hcaps_a])
mse_25_lcaps_a = str(mean_squared_error(par_est_25_lcaps['a'], par_sim_25_lcaps['a']).round(3))
mse_25_lcaps_a="".join([mse,mse_25_lcaps_a])
mse_25_hcaps_a = str(mean_squared_error(par_est_25_hcaps['a'], par_sim_25_hcaps['a']).round(3))
mse_25_hcaps_a="".join([mse,mse_25_hcaps_a])



# Helper: compute nRMSE
...
fig.write_image("study1_fig_caps_group_recovery_2025_reviewer.png",scale=3)
