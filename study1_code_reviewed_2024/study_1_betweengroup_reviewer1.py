...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 17 10:21:00 2025
...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 15:13:17 2024
...
par_comp=pd.concat([par_est_15_lc, par_est_25_lc,
...
#     , text='<b>★<b>'
#     ,showarrow=False
#     , font=dict(size=36, color="black", family="Courier New, monospace")
#     , xref='x1')
# fig.add_annotation(
#     x='High Coherence'
#     , y=1.35
...
fig.write_image("study1_fig_v_caps_2024_reviewr1.png",scale=3)
#%%
#a
...
fig.show()
fig.write_image("study1_fig_a_caps_2024_reviewr1.png",scale=3)
