...
mean_simulated_quantiles_caps=pd.read_csv('mean_simulated_quantiles_caps_2024.csv')
...
#qq plots
fig = make_subplots(
    rows=1, cols=2,subplot_titles=("HDDM-CAPS-C", "HDDM-CAPS-C",
                                  ),
...
fig.write_image("study1_predicted_quantiles_groups_2024.png",scale=3)
