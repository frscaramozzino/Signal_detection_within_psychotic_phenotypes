...
# -*- coding: utf-8 -*-
"""
Created on Fri May 17 11:49:24 2024
...
mean_simulated_quantiles_caps=pd.read_csv('mean_simulated_quantiles_pdi_reg_2024.csv')
mean_simulated_quantiles_asi=pd.read_csv('mean_simulated_quantiles_caps_reg_2024.csv')
...
#qq plots
fig = make_subplots(
    rows=2, cols=2,subplot_titles=("HDDM-LR-PDI-C", "HDDM-LR-PDI-C",
                                   "HDDM-LR-CAPS-C","HDDM-LR-CAPS-C"),
...
fig.write_image("study1_predicted_quantiles_reg_2024.png",scale=3)
